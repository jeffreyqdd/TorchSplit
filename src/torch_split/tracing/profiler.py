...
# # TODO: PreFLMR, BLIP, CLIP, VLA,
# # https://github.com/tcyuan373/Vortex_pipeline/tree/auto_script
# #
# # PADDLE OCR: https://github.com/PaddlePaddle/PaddleOCR
# # This is the gurobi solver https://github.com/aliciayuting/vortex_exp_data/blob/ALICIA_UPDATES/gurobi_allocation_algo.py

# # Look into cross modality components and it would be a good direction for the paper
# # https://huggingface.co/PaddlePaddle/PaddleOCR-VL

# # Language Encoders, Vision Encoders, and Audio Encoders.
